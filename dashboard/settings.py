...
SECRET_KEY = '$nnl#o$m&!jwczq(nle4s3_lapej1(3(iy(vx0!=u7l$dyaj9r'
...
COVERAGE_EXCLUDE_MODULES = ('dashboard.migrations', 'dashboard.tests',
...
DEFAULT_DOMAIN = 'http://dashboard.com/'

# Begins OPAL Settings you should edit !

OPAL_BRAND_NAME = 'dashboard'
